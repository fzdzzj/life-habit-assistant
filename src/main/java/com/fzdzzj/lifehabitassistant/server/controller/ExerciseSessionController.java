...
public class ExerciseSessionController {
    ...
    @GetMapping
    public Result<List<ExerciseSessionDtos.ExerciseSessionResponse>> list(@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
        return Result.success(service.list(date));
    }

    @PostMapping
    public Result<ExerciseSessionDtos.ExerciseSessionResponse> create(@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date, @Valid @RequestBody ExerciseSessionDtos.ExerciseSessionRequest request) {
        return Result.success(service.create(date, request));
    }

    @PutMapping("/{id}")
    public Result<ExerciseSessionDtos.ExerciseSessionResponse> update(@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date, @PathVariable Long id, @Valid @RequestBody ExerciseSessionDtos.ExerciseSessionRequest request) {
